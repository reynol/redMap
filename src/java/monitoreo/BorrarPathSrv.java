...
/**
 * Servlet que procesa las solicitudes para borrar un enlace.
 * @author Reynol Zacapala.
 */
public class BorrarPathSrv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Boolean res=c.deletePath(request.getParameter("enlace"));
