...
/**
 * Servlet que procesa las solicitudes para agarrar un nuevo mapa.
 * @author Reynol Zacapala.
 */
public class nuevoMapaSrv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             ...
             */
                    ...
                    //String src =  request.getParameter("evento");
               ...
               // Boolean res=
                     Integer res=   c.insertMap(nombre, tipo);
