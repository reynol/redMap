...
/**
 * Servlet que procesa las solicitudes para establecer un mapa de nivel superior como mapa actual.
 * @author Reynol Zacapala.
 */
public class SetParentMapAsActualSrv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(session!=null){
                ...
                System.out.println("Mapa padre como actual: "+idmapaPadre);
