	...
	function build() {
		...
		svg.Element.ElementBase = function(node) {	
			...
			this.addChild = function(childNode, create) {
				var child = childNode;
				console.log("paso por aqui addchilld linea 690 "+child);
		...
		svg.Element.image = function(node) {
			...
			console.log("paso por aqui imagen linea 2041");
			...
			console.log("El id: "+this.attribute('id').value);
			console.log("La imagen:"+this.attribute('href').value);
							...
							if (cssClass == '@font-face') {
								...
								for (var s=0; s<srcs.length; s++) {
									if (srcs[s].indexOf('format("svg")') > 0) {
										...
										console.log("paso por aqui 2063");
