...
$("#btn_export").button().click(function (){
		...
		console.log("___esto_");

		var strDataURI = oCanvas.toDataURL("image/png");
        strDataURI = strDataURI.substr(22, strDataURI.length);
		console.log("Numero de caracteres:"+strDataURI.length);


$('#download').val(strDataURI);
$('#super_form').submit();
console.log("Console.log: "+$('#download').val());
	...
	console.log("opciones  desde menu contextual");
